function [FitResult,FitParam] = PLOF_3(Offset,Saturation,FitParam)
...
% r2 = rsquare(CurveFunction(FitResult.Coefficents,Offset,FitParam),Saturation)

if FitParam.ifshowimage == 1
    PlotFitResult_3(FitResult,FitParam);
end
end